...
var RethinkDBDriver = Base.extend({
...
Promise.promisifyAll(RethinkDBDriver);

/**
 * Gets a connection to mongo
 *
 * @param config    - The config to connect to mongo
 * @param callback  - The callback to call with a RethinkDBDriver object
 */
exports.connect = function(config, intern, callback) {
  ...
  r.connect({
    ...
    callback(null, new RethinkDBDriver(conn));
  })
